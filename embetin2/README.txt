1. Download and install Google App Engine SDK for Java
2. Install 'Google Plugin for Eclipse' to your Eclipse IDE (update site: http://dl.google.com/eclipse/plugin/3.4)
3. Create a Google App Engine application and remember the app-id
4. Replace all references to 'embetin2' in the application by your app-id (step 3 above)
5. Use command 'mvn package eclipse:eclipse' to create Eclipse project files
...
7. Use appengine-java-sdk-1.2.0\bin\appcfg update <your-app>/target/<app-id> to upload the application to Google App Engine server
